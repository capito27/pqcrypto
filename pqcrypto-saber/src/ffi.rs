...
pub const PQCLEAN_SABER_CLEAN_CRYPTO_SECRETKEYBYTES: usize = 2208;
pub const PQCLEAN_SABER_CLEAN_CRYPTO_PUBLICKEYBYTES: usize = 896;
...
#[cfg(enable_aarch64_neon)]
pub const PQCLEAN_SABER_AARCH64_CRYPTO_SECRETKEYBYTES: usize = 2208;
#[cfg(enable_aarch64_neon)]
pub const PQCLEAN_SABER_AARCH64_CRYPTO_PUBLICKEYBYTES: usize = 896;
#[cfg(enable_aarch64_neon)]
pub const PQCLEAN_SABER_AARCH64_CRYPTO_CIPHERTEXTBYTES: usize = 960;
#[cfg(enable_aarch64_neon)]
